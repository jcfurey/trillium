...
import JoyTeleopPanel from "./index";

export default {
  title: "panels/JoyTeleop",
  component: JoyTeleopPanel,
  decorators: [
...
export const Unconfigured: StoryObj = {
  render: () => {
    return <JoyTeleopPanel />;
  },
};

export const WithSettings: StoryObj = {
  render: function Story() {
    return <JoyTeleopPanel overrideConfig={{ topic: "/teleop/joy" }} />;
  },
